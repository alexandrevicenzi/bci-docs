...
SUSE Linux Base Container Images (SUSE Linux BCI) is available from the https://registry.suse.com[SUSE Registry]. Use it like any other OCI-compatible container image.
...
To use SUSE Linux BCI Base in a `Dockerfile`, use it as follows:
